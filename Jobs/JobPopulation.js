...
const { InspectorCountryStat, Databases, AltUser } = require("../db");
const { AuthorizedApiCall } = require("../Osu");
...
async function UpdatePopulationStats() {
    ...
    for await (const country of countries) {
        try {
            ...
            const [_data] = await Databases.osuAlt.query(`
                SELECT 
                    count(*) as alt_scores, 
            ...
            const [_data2] = await Databases.osuAlt.query(`
